...
> [!NOTE]  
> For this estimation we need bandwidths per mode, you can try different ones
...
according to Equation (6) in [@Neumann.etal_2024] (cf. Equation (2.3) in @Yin.etal_2010 and (4) in [@Neumann.etal_2024] for the non pairwise estimation of the conditional covariance).
