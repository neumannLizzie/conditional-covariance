...
2. Penalized regression splines using mgcv [@Wood_2017], cf. Section 2.2 in [@Neumann.etal_2024]. 

3. Local Polynomial Regression using stats [@R_2023], cf. [@Neumann.etal_2024].

4. Nadaraya-Watson kernel estimator using our PACKAGE covest, cf. [@Neumann.etal_2024] and @Yin.etal_2010. 

> [!IMPORTANT]  
> Using method 4. requires specification of bandwidths per mode. You can try out different ones.
