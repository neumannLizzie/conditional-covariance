...
1. A bilinear model using R package segmented [3], cf. [2] and [4]. 

2. Penalized regression splines using mgcv [6], cf. Section 2.2 in [4]. 

3. Local Polynomial Regression using stats [5], cf. [4].

4. Nadaraya-Watson kernel estimator using our PACKAGE covest, cf. [4] and [7]. 
...
according to Equation (6) in [4] (for the non pairwise estimation of the 
conditional covariance compare Equation (2.3) in [7] and (4) in [4]).
...
[3] V. M. Muggeo. “segmented: an R Package to Fit Regression Models with Broken-Line Relationships.” R News, 8(1), 20–25. https://cran.r-project.org/doc/Rnews/, 2008.

[4] L. Neumann, P. Wittenberg, A. Mendler, and J. Gertheiss. Confounder-adjusted Covariances of Sensor Outputs and Applications to Structural Health Monitoring. JOURNAL/PREPRINT, PAGES, YEAR.

[5] R Core Team (2022). R: A language and environment for statistical computing. R Foundation for Statistical Computing, Vienna, Austria. URL
  https://www.R-project.org/.

[6] S. Wood. Generalized Additive Models: An Introduction with R, 2 edition. Chapman and Hall/CRC, 2017.

[7] J. Yin, Z. Geng, R. Li, and H. Wang. Nonparametric covariance model. Statistica Sinica 20, pages 469–479, 2010.
